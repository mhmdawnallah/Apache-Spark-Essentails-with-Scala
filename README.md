...
This repository entrypoint is cloned from [Rock the JVM's Spark Essentials with Scala](https://rockthejvm.com/course/spark-essentials)
and built upon while I'm progressing in the course.
